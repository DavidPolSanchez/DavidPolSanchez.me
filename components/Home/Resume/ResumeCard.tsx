  ...
  return (
    <div className="mb-16">
      <div className="flex items-start space-x-6 bg-green-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
        <div className="sm:w-14 sm:h-14 w-10 h-10 bg-green-900 rounded-full flex items-center justify-center flex-col">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-gray-200 tet-x1 sm:text-2xl font-semibold">
            {role}
            </h1>
